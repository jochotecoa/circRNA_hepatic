...
compound="AMI" #
OUTPUTDIR=/share/analysis/hecatos/juantxo/circRNA/ciri2/${compound}
timeTHE=("000" "002" "008" "024" "072" "168" "240" "336")
timeTOX=("000" "002" "008" "024" "072" "168" "240" "336")
dose=("The" "Tox")
samplename=()
reads=("R1" "R2")
replicates=("1" "2" "3")
...
for rep in ${samplename[@]} ; do
  FQR1=/ngs-data/data/hecatos/Cardiac/5-FU/TotalRNA/trimmed_reads/${rep}_R1_trimmed_PE.fastq #
  FQR2=/ngs-data/data/hecatos/Cardiac/5-FU/TotalRNA/trimmed_reads/${rep}_R2_trimmed_PE.fastq

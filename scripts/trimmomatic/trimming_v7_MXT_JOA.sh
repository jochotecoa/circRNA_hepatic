...
maindir="/share/data/hecatos/${tissue}/${compoundfolder}/TotalRNA"
inputdir="${maindir}/concatenated"
outputdir="${maindir}/trimmed_reads3"
trimmoversion="0.36"
trimmo="/share/data/Juantxo_tools/Trimmomatic-${trimmoversion}"
...
perlsoft="/share/data/Juantxo_tools/FastQC/fastqc"
...
########################
### perl /share/data/Juantxo/FastQC/fastqcraw reads ###
########################
